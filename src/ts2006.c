// Tabla de S�mbolos 2006
// Creada por Daniel Pe�a V�zquez
// Supervisada por Jos� Luis Fuertes Castro

// Este c�digo es C est�ndar.
...
// - BCC32 ( probado en la versi�n Borland C++ 5.5.1 )
// - Microsoft Visual C++ ( probado en la versi�n 6.0 )
...
int ultimo_id_error = 0; // ID del �ltimo error que se ha producido
...
{  // Devuelve numero entre 
  ...
  char letra;
  int ascii_letra;
  // no deber�a ocurrir que la cadena fuera NULL ,
  if (cadena == NULL)
  {
    // pero en ese caso se devolver� 0
    resultado = 0;  
  }
  else
  {
	...
	{
	  letra = cadena[i];
	  // Se convertir� cada letra a su valor entero ascii.
	  ascii_letra = (int) letra;
	  // Se sumar�n todos esos valores.
...
// ************** Crear una tabla de s�mbolos ******************************************
// Proceso DFD  : 1.1
// ID Requisito : REQ04
// Entrada      : <nada>
//
// Salida       : - Identificador de la tabla creada (n�mero positivo) si se cre�.
//                - Devuelve -1 si se produce un error.
// Descripci�n  : Crea una nueva tabla de s�mbolos y
...
// ************** Destruir una tabla de s�mbolos ***************************************
// Proceso DFD  : 1.2
// ID Requisito : REQ05
// Cabecera     : int destruir_tabla(int id_tabla);
// Entrada      : - Identificador de la tabla que se quiere destruir.
//
// Salida       : - Devuelve 0 si la operaci�n se realiz� correctamente.
//                - Devuelve -1 si se produce un error.
// Descripci�n  : Se destruye la tabla indicada.
// *************************************************************************************
...
// ************** Determinar la existencia de una tabla de s�mbolos ********************
// Proceso DFD  : 1.3
// ID Requisito : REQ15
...
//                - Devuelve -1 si se produce un error.
// Descripci�n  : Determina si una tabla existe 
...
// Salida       : - Devuelve 0 si la operaci�n se realiz� correctamente.
//                - Devuelve -1 si se produce un error.
// Descripci�n  : Crea una nueva entrada en la tabla indicada
...
int crear_entrada(int id_tabla, char *lexema)
{
  ...
  if (resultado == 0 )
  {
	...
	else // si ya existe alguno -> colision . Primero ver si ya existe ese lexema :
	{
	  ...
	  if (resultado == 0) 
	  { // si no existia el lexema ya, a�adirlo a la lista de colisiones para esa entrada
        nueva_entrada = (tipo_entrada *) malloc(sizeof(tipo_entrada));
		if (nueva_entrada == NULL) // sin memoria para mas
		{
	      ultimo_id_error = cte_error_sin_memoria; // Error: memoria agotada 
...
// Proceso DFD  : 2.2
// ID Requisito : REQ07
// Entrada      : - Identificador de la tabla de s�mbolos de la entrada.
//                - Lexema de la entrada.
//                - Tipo que se le quiere dar a la entrada.
//
// Salida       : - Devuelve 0 si la operaci�n se realiz� correctamente.
//                - Devuelve -1 si se produce un error.
// Descripci�n  : Asigna un tipo a una entrada existente.
// *************************************************************************************
...
// Descripci�n  : Consulta el tipo de una entrada.
// *************************************************************************************
...
//                - Devuelve 1 si no existe.
//                - Devuelve -1 si se produce un error.
// Descripci�n  : Determina si una entrada existe 
...
// Salida       : - Devuelve 0 si la operaci�n se realiz� correctamente.
//                - Devuelve -1 si se produce un error.
// Descripci�n  : Crea un nuevo atributo en la entrada, con el alias indicado. 
//                 Este atributo solo podr� almacenar valores enteros (tipo int de C)
// *************************************************************************************
...
//                - Devuelve -1 si se produce un error.
// Descripci�n  : Crea un nuevo atributo en la entrada, con el alias indicado. 
//                 Este atributo solo podr� almacenar cadenas (tipo char* de C)
// *************************************************************************************
...
// Salida       : - Devuelve 0 si la operaci�n se realiz� correctamente.
//                - Devuelve -1 si se produce un error.
// Descripci�n  : Da un valor al atributo (entero) de alias indicado en la 
...
// Salida       : - Devuelve 0 si la operaci�n se realiz� correctamente.
//                - Devuelve -1 si se produce un error.
// Descripci�n  : Da un valor al atributo (cadena) de alias indicado en la entrada 
...
// Descripci�n  : Consulta el valor de un atributo entero.
// *************************************************************************************
...
// Descripci�n  : Consulta el valor de un atributo cadena.
// *************************************************************************************
...
//                - Devuelve 1 si no existe.
//                - Devuelve -1 si se produce un error.
// Descripci�n  : Determina si un atributo (con el alias indicado) existe en una 
...
// Proceso DFD  : 4.1
// ID Requisito : REQ18
// Entrada      : - Identificador de la tabla de s�mbolos.
...
//                - Devuelve 0 si la operaci�n se realiz� correctamente.
//                - Devuelve -1 si se produce un error.
// Descripci�n  : Refleja el contenido actual de una tabla de s�mbolos 
...
{  // Crea un fichero con el contenido de la tabla indicada
   ...
   // Si la lista de tablas esta vac�a, no seguir.
...
// ************** Consultar el ID del �ltimo error que se ha producido *****************
// Proceso DFD  : 5.1
// ID Requisito : REQ19
// Entrada      : <nada>
//
// Salida       : - Devuelve un entero positivo que representa el 
//                   �ltimo error que se ha producido.
//                - Devuelve 0 si de momento no han ocurrido errores.
// Descripci�n  : Devuelve un valor num�rico que identifica el
//                 �ltimo error que se ha producido.
// *************************************************************************************
...
// ************** Consultar la descripci�n del �ltimo error que se ha producido ********
// Proceso DFD  : 5.2
// ID Requisito : REQ20
// Entrada      : <nada>
//
// Salida       : - Devuelve una cadena indicando la descripci�n del 
//                   �ltimo error que se ha producido.
//                - Devuelve la cadena vac�a ("") si de momento no han ocurrido errores.
// Descripci�n  : Devuelve una descripci�n textual en lenguaje natural 
//                 del �ltimo error que se ha producido.
// *************************************************************************************
...
{  // Devuelve la descripcion del ultimo error que se ha producido
   ...
   switch( ultimo_id_error )
   {
	 ...
	 case cte_error_ya_existe_atributo :
	   return "Ya exist�a el atributo. No se ha modificado";
	   break;	
	 ...
	 case cte_error_lexema_es_null :
	   return "NULL no es una cadena v�lida para denominar un lexema";
	   break;
	 case cte_error_alias_es_null :
	   return "NULL no es una cadena v�lida para denominar un atributo";
	   break;		 
     case cte_error_fichero_es_null :
	   return "NULL no es una cadena v�lida para denominar un fichero";
	   break;
     case cte_error_tipo_es_null :
	   return "NULL no es una cadena v�lida para denominar un tipo de entrada";
	   break;
	 case cte_error_creacion_fichero :
	   return "El sistema no permiti� crear el fichero";
	   break;
	 ...
	 case cte_error_tipo_entrada_no_definido :
	   return "El tipo de entrada a�n no se ha definido";
	   break;
	 ...
	 case cte_error_posicion_es_null : 
	   return "La posici�n indicada apunta a NULL";
	   break;
     default : 
	   return "Ocurri� un error por causas desconocidas";
	   break;
	}
}


// ************** Resetear la variable que almacena el �ltimo error producido  *********
// Proceso DFD  : 5.3
// ID Requisito : REQ32
// Entrada      : <nada>
//
// Salida       : <nada>
// Descripci�n  : Resetea la variable interna que indica el
//                 �ltimo error que se ha producido.
// *************************************************************************************
...
// Descripci�n  : Busca la posicion de una entrada 
