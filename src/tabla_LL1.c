...
int *tabla_LL1(int s, int token, int *regla)
{
    ...
    case _B:
    {
        ...
        {
            *regla = 7;
            static int res[12] = {LLAVE_DCH, _C, LLAVE_IZQ, PARENT_DCH, _M, PUNTO_COMA, _E, PUNTO_COMA, _M, PARENT_IZQ, FOR, -1};
            return res;
        }
        else if (token == ID)
        {
    ...
    case _W:
    {
        ...
        {
            *regla = 20;
            static int res[4] = {PUNTO_COMA, _E, _N, -1};
            return res;
        }
